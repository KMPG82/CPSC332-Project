...
if (isset($_POST['search']) && !empty($_POST['search'])) {
    ...
    $sql = "select * from event where Pub_date <= CURDATE() and Pub_time <= CURTIME() and  Status='Active' and Pub_date != 'null' and Pub_time != 'null' and Event_name = '$search'";
} else {
    //create the query to fetch all active events
    $sql = "select * from event where Pub_date <= CURDATE() and Pub_time <= CURTIME() and Status='Active' and Pub_date != 'null' and Pub_time != 'null'";
}
